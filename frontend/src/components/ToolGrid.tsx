...
const ToolGrid: React.FC = () => {
  ...
  const ToolCard: React.FC<{ tool: AITool }> = ({ tool }) => (
    ...
    >
      ...
      {/* Pricing */}
      <div className="mb-4">
        <PricingDisplay pricing={tool.pricing} />
      </div>
      ...
      <div className="mb-4">
        <div className="flex flex-wrap gap-1">
          ...
          {tool.features.length > 3 && (
            <span className="px-2 py-1 bg-gray-100 dark:bg-dark-700 text-gray-700 dark:text-gray-300 text-xs rounded-md">
        ...
        <div className="flex items-center space-x-2">
          {isAuthenticated && (
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${isFavorite(tool.id)
  ...
  return (
    <section id="tool-grid" className="py-16 bg-gray-50 dark:bg-dark-900">
