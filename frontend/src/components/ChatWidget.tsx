...
const ChatWidget: React.FC = () => {
    ...
    return (
        <>
            {/* Floating Chat Button - AI Assistant with Animation */}
            <motion.button
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                ...
                className="fixed bottom-6 right-6 bg-gradient-to-r from-primary-600 to-purple-600 hover:from-primary-700 hover:to-purple-700 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-3 px-4 py-3 z-40 group"
            >
                <motion.div
                    animate={{
                        rotate: [0, 10, -10, 0],
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-28 right-6 w-80 h-[450px] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden"
                    >
                        {/* Header */}
